...
class Text
{
	public:
		 ...
		 * @param centerX a bool argument containg if the text should be centralised in x
		 * @param centerY a bool argument containg if the text should be centralised in y
		 */
