...
class Sprite
{
	public:
		 ...
		 * @param frameCount a int argument containing how many frames does the sprite have
		 * @param frameTime a int argument containing how long will a frame be displayed
		 */
