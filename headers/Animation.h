...
class Animation : public GameObject
{
	public:
		 ...
		 * @param frameCount a int argument with the animation sprite number os frames
		 * @param frameTime a float argument with the frames time
		 * @param end a bool argument to check if the animation is played once or repeatedly
		 */
